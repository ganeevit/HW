...
codes = spark.read.option("header", "true").option("delimiter", ",").option("quote", "\"").option("escape", "\"").option("inferSchema", "true").csv(os.path.join(input_path1, "offense_codes.csv")).distinct()
